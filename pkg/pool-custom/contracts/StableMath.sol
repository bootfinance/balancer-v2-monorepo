...
library StableMath {
    ...
    returns (uint256)
    {
        ...
        **********************************************************************************************/
        ...
        // Dprev in the Curve version
        uint256 invariant = sum;
        // D in the Curve version
        uint256 ampTimesTotal = amplificationParameter * numTokens;
        // Ann in the Curve version
    ...
    function __getTokenBalanceGivenInvariantAndAllOtherBalances(
    ...
    function _calcOutGivenIn(
        ...
        **************************************************************************************************************/
        ...
        uint256 finalBalanceOut = __getTokenBalanceGivenInvariantAndAllOtherBalances(
    ...
    function __calcInGivenOut(
        ...
        **************************************************************************************************************/
        ...
        uint256 finalBalanceIn = __getTokenBalanceGivenInvariantAndAllOtherBalances(
            amplificationParameter,
            balances,
            invariant,
            tokenIndexIn
    ...
    function __alcBptOutGivenExactTokensIn(
        uint256 amp,
        uint256[] memory balances,
        ...
        uint256 newInvariant = __calculateInvariant(amp, newBalances);
    ...
    function __calcTokenInGivenExactBptOut(
        uint256 amp,
        uint256[] memory balances,
        uint256 tokenIndex,
        ...
        uint256 newBalanceTokenIndex = __getTokenBalanceGivenInvariantAndAllOtherBalances(
            amp,
            balances,
            newInvariant,
            tokenIndex
    ...
    */
    function __calcBptInGivenExactTokensOut(
        uint256 amp,
        uint256[] memory balances,
    ...
    function __calcTokenOutGivenExactBptIn(
        uint256 amp,
        uint256[] memory balances,
        uint256 tokenIndex,
        uint256 bptAmountIn,
