...
export type JoinExitCustomPool = {
  recipient?: Account;
...
export type JoinGivenInCustomPool = {
...
export type JoinGivenOutCustomPool = {
  token: number | Token;
  bptOut: BigNumberish;
  from?: SignerWithAddress;
  recipient?: Account;
...
export type ExitGivenOutCustomPool = {
...
export type SingleExitGivenInCustomPool = {
  bptIn: BigNumberish;
  token: number | Token;
  recipient?: Account;
  from?: SignerWithAddress;
...
export type MultiExitGivenInCustomPool = {
  bptIn: BigNumberish;
  recipient?: Account;
  from?: SignerWithAddress;
  currentBalances?: BigNumberish[];
